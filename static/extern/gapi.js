...
*/
    var g = this || self, h = function (a) {
        return a
    };/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var m = window, n = document, aa = m.location, ba = function () {
    }, ca = /\[native code\]/, q = function (a, b, c) {
        return a[b] = a[b] || c
    }, da = function (a) {
        a = a.sort();
    ...
    var F = q(C, "perf", v()), G = q(F, "g", v()), ha = q(F, "i", v());
    q(F, "r", []);
    v();
    v();
    ...
    var ia = /^(\/[a-zA-Z0-9_\-]+)+$/, R = [/\/amp\//, /\/amp$/, /^\/amp$/], ja = /^[a-zA-Z0-9\-_\.,!]+$/,
        ka = /^gapi\.loaded_[0-9]+$/, la = /^[a-zA-Z0-9,._-]+$/, pa = function (a, b, c, d) {
            var e = a.split(";"), f = e.shift(), l = M[f], k = null;
    ...
    var U = decodeURI("%73cript"), V = /^[-+_0-9\/A-Za-z]+={0,2}$/, W = function (a, b) {
        ...
        k = q(E(c), "r", []).sort();
        var O = q(E(c), "L", []).sort(), I = [].concat(k), ea = function (u, A) {
            if (z) return 0;
            m.clearTimeout(y);
            O.push.apply(O, p);
    ...
    var Ba = null, Z = g.trustedTypes;
    if (Z && Z.createPolicy) try {
        Ba = Z.createPolicy("gapi#gapi", {createHTML: h, createScript: h, createScriptURL: h})
    } catch (a) {
...
gapi.load("", {
    callback: window["gapi_onload"], _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_GB.BP0hn3kLWmU.O/am\u003dAQ/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCOlROx04j7W4rL-c31QetYpflsFoQ/m\u003d__features__",
